...
// constructor, unmarshal and marshal must not call into futura: they run under the execution's locks and deadlock.
// cleanup runs after the execution ended, and may use another handle.
