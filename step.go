...
// ComparableMoment is a function that is has comparable inputs and returns a comparable type.
// This is to ensure deep memoization of the inputs is done correctly,
// and to enforce immutability of the output.
type ComparableMoment[A comparable, R comparable] func(ctx context.Context, args A) (R, error)
...
func Step[A comparable, R comparable](b FlowBuilder, fn ComparableMoment[A, R], args A, options ...ftype.MomentFnOption) (output R, err error) {
